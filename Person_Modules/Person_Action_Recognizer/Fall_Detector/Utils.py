...
class Graph:
    ...
    def __init__(self,
                 ...
                 max_hop=1,
                 dilation=1):
        print('max_hop = {}, dilation = {},'.format(max_hop,dilation))
    ...
    def get_edge(self, layout):
        if layout == 'coco_cut':
            ...
            print('self.edge = {}'.format(self.edge))
            self.center = 13
        else:
    ...
    def get_adjacency(self, strategy):
        ...
        print('valide_hop = {}, num_node ={}'.format(valid_hop, self.num_node))
...
def normalize_digraph(A): # Adjacency matrix에서 연결된 edge수로 나눈다.
    Dl = np.sum(A, 0)
    num_node = A.shape[0]
